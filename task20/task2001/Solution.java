...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            File your_file_name = new File("c://java/temp.txt");
    ...
    public static class Human {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            //сразу пишем имя так-как оно не может быть пустым
            writer.println(name);
            writer.flush();

            //Сохранение активов человека
            ...
            if(isAssets.equals("yes")){
                for(Asset as : assets) {
                    writer.println(as.getName()+" "+as.getPrice());
                    writer.flush();
                }
            }
            writer.close();
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            if(isAssets.equals("yes")){
                ...
                while ((line = reader.readLine())!=null) {
                    ...
                    assets.add(new Asset(buff[0], Double.parseDouble(buff[1])));
                }
            }
            reader.close();
        }
